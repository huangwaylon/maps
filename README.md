...
| Review text and blurbs kept out of both | a 40-place question can touch every shard, so model context comes from one small `digest.json` fetched on first Ask |
